...
def snv_consensus_extras( name_rec, block_id, blockchain_name_data, db ):
    ...
    ret_op = ysi_client.operations.transfer.snv_consensus_extras( name_rec, block_id, blockchain_name_data, transfer_send_block_id_consensus_hash=transfer_send_block_id_consensus_hash )
