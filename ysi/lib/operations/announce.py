...
def process_announcement( op ):
    ...
    # go get the text...
    announcement_text = ysi_client.storage.get_announcement( announce_hash )
...
def check( state_engine, nameop, block_id, checked_ops ):
    """
    Log an announcement from the ysi developers,
...
def snv_consensus_extras( new_name_rec, block_id, blockchain_name_data, db ):
    ...
    """
    return ysi_client.operations.announce.snv_consensus_extras( new_name_rec, block_id, blockchain_name_data )
    '''
    return {}
    '''
