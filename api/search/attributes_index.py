...
from ysi_proofs import profile_to_proofs,  contains_valid_proof_statement
from ysi_proofs.domain import get_proof_from_txt_record
...
def create_domain_proofs_index():
    ...
    TEST_DOMAIN_VERIFICATIONS = ['muneeb', 'ysi', 'ryan']
