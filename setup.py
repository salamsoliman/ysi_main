...
exec(open("ysi_client/version.py").read())
...
setup(
    ...
    scripts=['bin/ysi-server', 'bin/ysi-core', 'bin/ysi-snapshots',
             'bin/ysi', 'bin/ysi-subdomain-registrar'],
    download_url='https://github.com/ysi/blockstore/archive/master.zip',
    zip_safe=False,
