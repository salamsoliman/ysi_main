...
# This module lets the ysi client treat local disk as a storage provider.
...
log = get_logger("ysi-storage-driver-disk")
...
if os.environ.get("BLOCKSTACK_TEST", None) is not None:
    DISK_ROOT = "/tmp/ysi-disk"
else:
    DISK_ROOT = os.path.expanduser("~/.ysi/storage-disk")
...
if __name__ == "__main__":
   ...
   from ysi_client.storage import serialize_mutable_data, parse_mutable_data
   from ysi_client.user import make_mutable_data_info
