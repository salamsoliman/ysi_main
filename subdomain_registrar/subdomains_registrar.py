...
from ysi_client import schemas, subdomains
from ysi_client import constants as ysi_constants
import ysi_zones
...
START_HELP = """ usage: ysi-subdomain-registrar start <domainname:required> """
def main_entry():
    if len(sys.argv) < 2:
        print START_HELP
        exit(1)
