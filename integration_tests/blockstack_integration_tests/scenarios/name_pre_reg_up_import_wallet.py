...
def scenario( wallets, **kw ):
    ...
    payment_address = virtualchain.BitcoinPrivateKey(wallets[2].privkey).public_key().address()
    owner_address = virtualchain.BitcoinPrivateKey(wallets[3].privkey).public_key().address()
    ...
    res = testlib.ysi_cli_import_wallet( "0123456789abcdef", wallets[2].privkey, wallets[3].privkey, wallets[4].privkey )
    if 'error' in res:
