...
def scenario( wallets, **kw ):
    ...
    resp = testlib.ysi_name_preorder( "foo.test", wallets[2].privkey, wallets[3].addr, consensus_hash=consensus_hash )
    if debug or 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    resp = testlib.ysi_name_update( "foo.test", "11" * 20, wallets[3].privkey, consensus_hash=consensus_hash )
    if debug or 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    resp = testlib.ysi_name_transfer( "foo.test", wallets[4].addr, True, wallets[3].privkey, consensus_hash=consensus_hash ) 
    if debug or 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    resp = testlib.ysi_name_update( "foo.test", "22" * 20, wallets[4].privkey, consensus_hash=consensus_hash )
    if debug or 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    resp = testlib.ysi_name_transfer( "foo.test", wallets[3].addr, False, wallets[4].privkey, consensus_hash=consensus_hash )
    if debug or 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    resp = testlib.ysi_name_update( "foo.test", "33" * 20, wallets[3].privkey, consensus_hash=consensus_hash )
    if debug or 'error' in resp:
        print json.dumps( resp, indent=4 )
