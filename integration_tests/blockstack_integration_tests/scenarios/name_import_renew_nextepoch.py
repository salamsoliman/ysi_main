...
def check( state_engine ):
    ...
    current_fee = original_price * ysi.lib.config.get_epoch_price_multiplier( 266, "test" )
    current_price = ysi.price_name( "foo", namespace_rec, 266 )
    ...
    epoch_cost_multiplier = ysi.get_epoch_price_multiplier( 266, "test" )
