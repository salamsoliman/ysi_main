...
def test_name_count(expected_num, expected_cum_num):
    num_names = ysi_client.proxy.get_num_names()
    num_names_cum = ysi_client.proxy.get_num_names(include_expired=True)
    ...
    num_names_res = testlib.ysi_REST_call('GET', '/v1/blockchains/bitcoin/name_count', None)
    ...
    num_names_cum_res = testlib.ysi_REST_call('GET', '/v1/blockchains/bitcoin/name_count', None, all='True')
