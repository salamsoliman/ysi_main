...
TEST ENV BLOCKSTACK_EPOCH_3_NAMESPACE_GRACE_PERIOD 0
"""
...
def scenario( wallets, **kw ):
    ...
    # renew/tranfer/update
    for i in xrange(1, 4):
        name = 'foo{}.test'.format(i)

        resp = testlib.ysi_name_renew( name, wallets[3].privkey, zonefile_hash='{}a'.format(i) * 20, recipient_addr=wallets[0].addr )
        if 'error' in resp:
            print resp
            return False
