...
def scenario( wallets, **kw ):
    ...
    testlib.ysi_name_transfer( "foo.test", wallets[3].addr, True, wallets[0].privkey )
    testlib.ysi_name_transfer( "bar.test", wallets[3].addr, True, wallets[1].privkey )
    testlib.ysi_name_transfer( "baz.test", wallets[3].addr, True, wallets[2].privkey )
    testlib.next_block( **kw )
