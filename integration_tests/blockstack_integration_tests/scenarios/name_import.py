...
def scenario( wallets, **kw ):
    ...
    resp = testlib.ysi_name_import( "foo.test", wallets[3].addr, "11" * 20, private_keys[0] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    # import twice
    resp = testlib.ysi_name_import( "bar.test", wallets[4].addr, "22" * 20, private_keys[0] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )

    testlib.next_block( **kw )

    resp = testlib.ysi_name_import( "bar.test", wallets[4].addr, "33" * 20, private_keys[1] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    resp = testlib.ysi_name_import( "baz.test", wallets[5].addr, "44" * 20, private_keys[0] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )

    resp = testlib.ysi_name_import( "baz.test", wallets[5].addr, "55" * 20, private_keys[1] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )

    resp = testlib.ysi_name_import( "baz.test", wallets[5].addr, "66" * 20, private_keys[2] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )
    ...
    resp = testlib.ysi_name_import( "foo.test", wallets[5].addr, "66" * 20, private_keys[0] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )

    resp = testlib.ysi_name_import( "bar.test", wallets[3].addr, "77" * 20, private_keys[1] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )

    resp = testlib.ysi_name_import( "baz.test", wallets[4].addr, "88" * 20, private_keys[2] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )
