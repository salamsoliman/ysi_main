...
def scenario( wallets, **kw ):
    ...
    testlib.ysi_name_preorder( "foo.test", wallets[2].privkey, wallets[3].addr, safety_checks=False )
    testlib.ysi_name_preorder( "foo.test", wallets[4].privkey, wallets[5].addr, safety_checks=False )
    testlib.ysi_name_preorder( "foo.test", wallets[0].privkey, wallets[1].addr, safety_checks=False )
    testlib.ysi_name_preorder( "foo.test", wallets[5].privkey, wallets[2].addr, safety_checks=False )
    testlib.next_block( **kw )

    # all of these should fail, since they're in the same block
    testlib.ysi_name_register( "foo.test", wallets[2].privkey, wallets[3].addr, safety_checks=False )
    testlib.ysi_name_register( "foo.test", wallets[4].privkey, wallets[5].addr, safety_checks=False )
    testlib.ysi_name_register( "foo.test", wallets[0].privkey, wallets[1].addr, safety_checks=False )
    testlib.ysi_name_register( "foo.test", wallets[5].privkey, wallets[2].addr, safety_checks=False )
    testlib.next_block( **kw )
