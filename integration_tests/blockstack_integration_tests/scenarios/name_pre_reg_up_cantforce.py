...
def scenario( wallets, **kw ):
    ...
    testlib.ysi_name_update( "foo.test", "22" * 20, wallets[4].privkey, safety_checks=False ) 
    testlib.ysi_name_update( "foo.test", "11" * 20, wallets[3].privkey, safety_checks=False )
    testlib.next_block( **kw )
