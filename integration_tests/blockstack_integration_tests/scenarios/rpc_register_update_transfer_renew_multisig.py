...
def scenario( wallets, **kw ):
    ...
    wallet = testlib.ysi_client_initialize_wallet( "0123456789abcdef", wallets[2].privkey, wallets[3].privkey, wallets[6].privkey )
    ...
    wallet = testlib.ysi_client_set_wallet( "0123456789abcdef", wallets[5].privkey, wallets[4].privkey, wallets[6].privkey )
