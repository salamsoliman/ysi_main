...
def scenario( wallets, **kw ):
    ...
    # actually expire
    for i in xrange(0, 5 * ysi_server.config.get_epoch_namespace_lifetime_multiplier( testlib.get_current_block(**kw), "test" ) - 5):
        testlib.next_block( **kw )
...
def check( state_engine ):
    ...
    curr_price = original_price * ysi_server.lib.config.get_epoch_price_multiplier( 267, "test" )
