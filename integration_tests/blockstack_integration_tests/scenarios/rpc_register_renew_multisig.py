...
from ysi_client.constants import DEFAULT_DUST_FEE, DEFAULT_OP_RETURN_FEE, NAME_RENEWAL
...
def scenario( wallets, **kw ):
    ...
    global zonefile_hash, final_balance, error, new_expire_block
...
def check( state_engine ):
    ...
    name_fee = ysi_server.price_name( "foo", ns, new_expire_block )
