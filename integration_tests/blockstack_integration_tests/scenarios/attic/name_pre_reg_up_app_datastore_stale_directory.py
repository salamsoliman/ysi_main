...
def scenario( wallets, **kw ):
    ...
    backup_dir = '/tmp/ysi-disk-backup.{}'.format(time.time())
    if os.path.exists(backup_dir):
        shutil.rmtree(backup_dir)

    shutil.copytree('/tmp/ysi-disk', backup_dir)
    ...
    shutil.copytree('/tmp/ysi-disk', backup_dir_2)
    shutil.rmtree('/tmp/ysi-disk')
    shutil.copytree(backup_dir, '/tmp/ysi-disk')
    ...
    for dpath in ['/file1', '/file2', '/dir1/file3', '/dir1/dir3/file4', '/dir1/dir3/dir4/file5']:
        ...
        res = testlib.ysi_cli_datastore_getfile( "foo.test", datastore_id, dpath, ses, force=True )
        if 'error' not in res or 'errno' not in res:
    ...
    for dpath in ['/dir1/dir3/dir4', '/dir1/dir3', '/dir2', '/dir1']:
        print 'stat {} (expect failure)'.format(dpath)
        res = testlib.ysi_cli_datastore_stat( "foo.test", datastore_id, dpath, ses, force=True )
        if 'error' in res:
            print 'failed to stat {}: {}'.format(dpath, res['error'])
            return False
    ...
    for dpath, expected in [('/', ['file1', 'file2']), ('/dir1', ['file3']), ('/dir1/dir3', ['file4']), ('/dir1/dir3/dir4', [])]:
        ...
        res = testlib.ysi_cli_datastore_listdir( "foo.test", datastore_id, dpath, ses, force=True )
        if 'error' in res:
            print 'failed to listdir {}: {}'.format(dpath, res['error'])
            return False
    ...
    for dpath in ['/file1', '/file2', '/dir1/file3', '/dir1/dir3/file4', '/dir1/dir3/dir4/file5']:
        ...
        res = testlib.ysi_cli_datastore_deletefile( "foo.test", datastore_pk, dpath, ses, force=True )
        if 'error' not in res or 'errno' not in res:
    ...
    for dpath in ['/dir1/dir3/dir4', '/dir1/dir3', '/dir2', '/dir1']:
        ...
        res = testlib.ysi_cli_datastore_rmdir( "foo.test", datastore_pk, dpath, ses, force=True )
        if 'error' in res:
