...
log = virtualchain.get_logger("name_preorder_register_update_ysiurl")
...
def scenario( wallets, **kw ):
    ...
    wallet_keys_2 = testlib.ysi_client_initialize_wallet( "0123456789abcdef", wallets[9].privkey, wallets[6].privkey, wallets[7].privkey )
    ...
    # make datastore 
    res = testlib.ysi_cli_create_datastore( datastore_pk )
    if 'error' in res:
    ...
    log.debug("putfile")
    res = testlib.ysi_cli_datastore_putfile( datastore_pk, '/hello_datastore', data )
    if 'error' in res:
    ...
    # make a directory 
    log.debug("mkdir")
    res = testlib.ysi_cli_datastore_mkdir( datastore_pk,  '/hello_dir' )
    if 'error' in res:
    ...
    res = testlib.ysi_cli_datastore_putfile( datastore_pk, '/hello_dir/hello_dir_datastore', data )
    if 'error' in res:
