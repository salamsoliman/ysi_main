...
def scenario( wallets, **kw ):
    ...
    resp = testlib.ysi_name_preorder_multi( ["foo2.test", "bar2.test"], wallets[2].privkey, [wallets[3].addr, wallets[4].addr])
    if 'error' in resp:
    ...
    import ysi.lib.operations as ops
    ...
    resp = testlib.ysi_name_preorder_multi( ["foo4.test", "bar4.test", "baz4.test", "goo4.test"], wallets[2].privkey, [wallets[3].addr, wallets[4].addr, wallets[5].addr, wallets[6].addr] )
    if 'error' in resp:
        print json.dumps( resp, indent=4 )
        sys.exit(1)
    ...
    resp = testlib.ysi_name_preorder_multi( ["foo6.test", "bar6.test", "baz6.test", "goo6.test", "quux6.test", "norf6.test"], wallets[2].privkey, \
    ...
    # should fail 
    resp = testlib.ysi_name_preorder_multi( ["foo1.test"], wallets[2].privkey, [wallets[3].addr] )
    ...
    # should fail 
    resp = testlib.ysi_name_preorder_multi( ["foo3.test", "bar3.test", "baz3.test"], wallets[2].privkey, [wallets[3].addr, wallets[4].addr, wallets[5].addr])
    if 'error' not in resp:
        print json.dumps( resp, indent=4 )
        sys.exit(1)
    ...
    # should fail
    resp = testlib.ysi_name_preorder_multi( ["foo5.test", "bar5.test", "baz5.test", "goo5.test", "quux5.test"], wallets[2].privkey, \
    ...
    # should fail 
    resp = testlib.ysi_name_preorder_multi( ["foo7.test", "bar7.test", "baz7.test", "goo7.test", "quux7.test", "norf7.test", "xyzzy7.test"], wallets[2].privkey, \
...
def check( state_engine ):
    ...
    if preorder['op_fee'] < ysid.get_name_cost( 'foo2.test' ) + ysid.get_name_cost( 'bar2.test' ):
    ...
    if preorder['op_fee'] < ysid.get_name_cost( 'foo4.test' ) + ysid.get_name_cost( 'bar4.test' ) + \
                            ysid.get_name_cost( 'baz4.test' ) + ysid.get_name_cost( 'goo4.test' ):
    ...
    if preorder['op_fee'] < ysid.get_name_cost( 'foo6.test' ) + ysid.get_name_cost( 'bar6.test' ) + \
                            ysid.get_name_cost( 'baz6.test' ) + ysid.get_name_cost( 'goo6.test' ) + \
                            ysid.get_name_cost( 'quux6.test') + ysid.get_name_cost( 'norf6.test' ):
