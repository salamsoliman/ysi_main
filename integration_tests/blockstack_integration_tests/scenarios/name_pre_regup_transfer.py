...
def scenario( wallets, **kw ):
    ...
    testlib.ysi_name_transfer( 'foo1.test', wallets[4].addr, True, wallets[3].privkey )
    testlib.ysi_name_transfer( 'foo2.test', wallets[4].addr, True, wallets[3].privkey )
    testlib.ysi_name_transfer( 'foo3.test', wallets[4].addr, True, wallets[3].privkey )
    ...
    testlib.ysi_name_transfer( 'foo1.test', wallets[0].addr, False, wallets[4].privkey )
    testlib.ysi_name_transfer( 'foo2.test', wallets[0].addr, False, wallets[4].privkey )
    testlib.ysi_name_transfer( 'foo3.test', wallets[0].addr, False, wallets[4].privkey )
    ...
    for i in xrange(1, 4):
        ...
        if res.has_key('zoenfile_hash') and res['zonefile_hash']:
            print res
            return False
