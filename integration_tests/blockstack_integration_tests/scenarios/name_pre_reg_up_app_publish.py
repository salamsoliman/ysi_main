...
def scenario( wallets, **kw ):
    ...
    res = testlib.ysi_cli_app_put_resource("foo.test", "ping.app", "hello_world", resource_file_path, password="0123456789abcdef" )
    if 'error' in res:
...
def check( state_engine ):
    ...
    for i in xrange(0, len(names)):
        ...
        # get index file 
        index_file = testlib.ysi_cli_app_get_resource("foo.test", "ping.app", "index.html")
        ...
        # get resource 
        resource_data_res = testlib.ysi_cli_app_get_resource("foo.test", "ping.app", "hello_world")
