...
def scenario( wallets, **kw ):
    ...
    for i in xrange( 0, 20 ):
        ...
        if (i % 2) != 0:
            ...
            resp = testlib.ysi_name_update( "foo.test", update_hash, wallets[3].privkey )
...
def check( state_engine ):
    ...
    # get history...
    name_history = ysi_client.get_name_blockchain_history( "foo.test", name_rec['first_registered'], state_engine.get_current_block()+1 )
