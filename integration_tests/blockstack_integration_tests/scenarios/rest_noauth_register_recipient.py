...
def scenario( wallets, **kw ):
    ...
    res = testlib.ysi_REST_call('POST', '/v1/wallet/balance', None, api_pass=api_pass, data={'address': wallets[4].addr, 'amount': 100000} )
    ...
    # should fail
    res = testlib.ysi_REST_call('POST', '/v1/names', None, api_pass=api_pass, data=data)
    if res['http_status'] == 200:
