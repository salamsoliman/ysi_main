...
def scenario( wallets, **kw ):
    ...
    # renew/xfer/update
    res = testlib.ysi_name_renew("foo.test", wallets[3].privkey, zonefile_hash="22" * 20, recipient_addr=wallets[4].addr)
    if 'error' in res:
        print res
        return False
    ...
    # renew/update 
    res = testlib.ysi_name_renew("foo.test", wallets[4].privkey, zonefile_hash="33" * 20)
    if 'error' in res:
        print res
        return False
    ...
    # renew/xfer 
    res = testlib.ysi_name_renew("foo.test", wallets[4].privkey, recipient_addr=wallets[1].addr)
    if 'error' in res:
        print res
        return False
