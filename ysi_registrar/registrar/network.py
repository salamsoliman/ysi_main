...
from ysi_profiles import is_profile_in_legacy_format
...
from ysi_client.proxy import get_name_blockchain_record
...
def dontUseServer(ysid_server):
    """
        Return false if server fails any tests
    """

    from registrar.config import CONSENSUS_SERVERS
    from ysi_client.proxy import BlockstackRPCClient as Proxy

    servers_to_check = CONSENSUS_SERVERS
    servers_to_check.append(ysid_server)
