...
# to generate:
# * create a virtualenv
# * pip install ysi-client
# * pip install homebrew-pypi-poet
# * poet ysi > /path/to/resources

class Blockstack < Formula
  desc "Blockstack command-line client"
  homepage "https://ysi.org"
  url "https://files.pythonhosted.org/packages/8d/37/db5313cb8087a64fc1e783052c97d42ffa976e54d83b3181034c32fb428b/ysi-0.14.1.1.tar.gz"
  ...
  resource "ysi-profiles" do
    url "https://files.pythonhosted.org/packages/a7/72/04d52473b1960730d2a1c32183701d2e23322b762b9c4bc151a2ed890243/ysi-profiles-0.14.1.tar.gz"
    sha256 "1c50cdf6e42a1cb058d39f9533903a30060bdc84f4c87de6275db7e1a928f72c"
  end

  resource "ysi-zones" do
    url "https://files.pythonhosted.org/packages/df/c0/3ce945dda86c0d3df188f0196a2210957a0e257c03453a60b7f40e871ce1/ysi-zones-0.14.1.tar.gz"
  ...
  def install
    ...
    %w[base58 basicrpc bitcoin bitmerchant ysi-profiles ysi-zones boto cachetools cffi commontools cryptography defusedxml ecdsa enum34 idna ipaddress jsontokens keychain keylib mixpanel protocoin pyasn1 pybitcoin pycparser pycrypto python-bitcoinrpc requests six utilitybelt virtualchain].each do |r|
      resource(r).stage do
